    ...
    return(
        <div className='productdisplay'>
            ...
            <div className="productdisplay-right">
                ...
                Made from a premium blend of cotton and elastane, these jeans offer superior stretchability, allowing you to move with ease while maintaining their shape and form.
                </div>
